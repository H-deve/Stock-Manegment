...
*/
    ...
    /** Cette methode permet de creer un fichier texte e partir du contenu d'un StringBuffer.
        @param nomFichier Le nom du fichier qui est cr�� dans le repertoire courant
        @param strbuf Le StringBuffer contenant le texte e ecrire. 
    ...
    */
    ...
    /** Cette methode lit une chaene de caractere
        @return String la chaene saisie dans la console d'execution
    ...
    */
    ...
    /** Cette methode ecrit une chaine et ne revient pas e la ligne.
    ...
    */
    ...
    /** Cette methode ecrit une chaine et revient e la ligne.
        @param s la chaine &agrave; &eacute;crire
    */
    ...
    /** Cette methode ecrit un entier et ne revient pas e la ligne.
        @param i l'entier e ecrire
    */
    ...
    /** Cette methode ecrit un entier et revient e la ligne.
        @param i l'entier e ecrire
    */
    ...
    /** Cette methode ecrit un boolean et ne revient pas e la ligne.
        @param b le booleen e ecrire
    */
    public static void ecrireBoolean(boolean b){
        ecrireString(""+b);
    }

    /** Cette methode ecrit un boolean et revient e la line.
        @param b le booleen e ecrire
    */
    ...
    /** Cette methode ecrit un double et ne revient pas e la ligne.
        @param d le double e ecrire
    */
    ...
    /** Cette methode ecrit un double et revient e la ligne.
        @param d le double e ecrire
    */
    ...
    /** Cette methode ecrit un caractere et ne revient pas e la ligne.
        @param c le caractere e ecrire
    */
    ...
    /** Cette methode ecrit un caractere et revient e la ligne.
        @param c le caractere e ecrire
    */
    ...
    /** Cette methode revient e la ligne.
    */
