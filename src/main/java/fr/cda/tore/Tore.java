...
public class Tore
{
    ...
    */
    ...
    /**
     Cette methode consiste e determiner le point le plus proche de A dans un espace de Tore parmi un ensemble de points ET dont la distance est superieur e une distance seuil.
     @param A coordonnees du point A
     ...
     <br>
     Remarque: A peut appartenir e l'ensemble des points.
    */
